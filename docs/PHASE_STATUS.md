...
|---:|---|---|---|
| -1 | Legacy Audit & Specification Reset | NOT_STARTED | |
| 0 | Pure Dart Domain Foundation | NOT_STARTED | |
| 1 | Repository + SQLite Architecture | REVIEW | Ready for review after Phase 1 implementation & tests |
...
Chỉ cập nhật `DONE` sau review và acceptance checklist pass.
